...
parser.add_argument('--mode', type=str, default='lineal', help='modo de linealizacion spline o lineal')
...
parser.add_argument('--instrument', type=str, default='feros', help='espectrografo utilizado, tambien sirve ceres')
